...
func NewMockTrackGetter(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockTrackGetter {
	mock := &MockTrackGetter{}
	mock.Mock.Test(t)
...
// MockTrackGetter is an autogenerated mock type for the TrackGetter type
type MockTrackGetter struct {
	mock.Mock
}

type MockTrackGetter_Expecter struct {
	mock *mock.Mock
}

func (_m *MockTrackGetter) EXPECT() *MockTrackGetter_Expecter {
	return &MockTrackGetter_Expecter{mock: &_m.Mock}
}

// GetPlaylistTracks provides a mock function for the type MockTrackGetter
func (_mock *MockTrackGetter) GetPlaylistTracks(ctx context.Context, playlistID string, limit int, offset int) (models.PlaylistTrackPage, error) {
...
// MockTrackGetter_GetPlaylistTracks_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetPlaylistTracks'
type MockTrackGetter_GetPlaylistTracks_Call struct {
	*mock.Call
}
...
//   - limit int
//   - offset int
func (_e *MockTrackGetter_Expecter) GetPlaylistTracks(ctx interface{}, playlistID interface{}, limit interface{}, offset interface{}) *MockTrackGetter_GetPlaylistTracks_Call {
	return &MockTrackGetter_GetPlaylistTracks_Call{Call: _e.mock.On("GetPlaylistTracks", ctx, playlistID, limit, offset)}
}

func (_c *MockTrackGetter_GetPlaylistTracks_Call) Run(run func(ctx context.Context, playlistID string, limit int, offset int)) *MockTrackGetter_GetPlaylistTracks_Call {
...
func (_c *MockTrackGetter_GetPlaylistTracks_Call) Return(playlistTrackPage models.PlaylistTrackPage, err error) *MockTrackGetter_GetPlaylistTracks_Call {
	_c.Call.Return(playlistTrackPage, err)
	return _c
}

func (_c *MockTrackGetter_GetPlaylistTracks_Call) RunAndReturn(run func(ctx context.Context, playlistID string, limit int, offset int) (models.PlaylistTrackPage, error)) *MockTrackGetter_GetPlaylistTracks_Call {
	_c.Call.Return(run)
	return _c
}
